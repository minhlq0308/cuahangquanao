...
<div id="content">
    ...
    <section class="padding-top-100 padding-bottom-100">
        ...
        ?>
        <!-- View All Items -->
        <div class="text-center margin-top-30"><a href="?mod=shop" class="btn margin-right-20">Xem tất cả sản phẩm</a>
        </div>
    </section>
    <!-- Popular Products -->
