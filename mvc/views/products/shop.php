            ...
            <div class="row">
                ...
                <div class="col-md-10">
                    <div class="sidebar-layout">
                        ...
                        <div class="item-fltr">
                            <!-- short-by -->
                            <div class="short-by"> Hiển thị 1–<?=count($dataViews['product']['data'])?> trong <?=$dataViews['product']['total']['total']?> kết quả </div>
                            <!-- List and Grid Style -->
                            <div class="lst-grd">
                                ...
                                <div class="item">
                                    <div class="img-ser">
                                        ...
                                        <div class="thumb"> <img class="img-1" src="<?= MAIN_URL ?>assets/images/products/<?=$pro['proImage']?>" alt=""><img class="img-2" src="<?= MAIN_URL ?>assets/images/products/<?=$pro['proImage']?>" alt="">
                                            <!-- Overlay  -->
                                            <div class="overlay">
                                                <div class="add-crt"><a href="?mod=product&act=detail&id=<?=$pro['proID']?>"><i class="icon-basket margin-right-10"></i>Đi tới giỏ hàng</a></div>
                                            </div>
                                        </div>
