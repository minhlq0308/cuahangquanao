...
<!--                                        onclick="return checkValue();"-->
                                        <li class="col-sm-8"> <button class="btn" type="submit" id="show-order" data-toggle="modal" data-backdrop="false" data-target="" onclick="addCart(<?= $dataViews['pro']['proID']?>);">Đi tới giỏ hàng</button> </li>
                                    </ul>
                            </form>
                            <!-- Modal -->
                                ...
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalCenterTitle">Đi tới giỏ hàng</h5>
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="button" id="go-to-cart" class="btn btn-primary">Đi tới giỏ hàng</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="inner-info">
                                        <h5>Chia sẻ sản phẩm với mọi người</h5>
                                        <!-- Social Icons -->
