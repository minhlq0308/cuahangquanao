...
<div id="wrap">
    ...
    <div class="top-bar">
        <div class="container-full">
            <p><i class="icon-envelope"></i> minhlq.it@gmail.com </p>
            ...
            <div class="login-info">
                <ul>
                    ...
                    if (isset($_SESSION['user'])){ ?>
                        ...
                        <li><a href="?mod=profile"> Tài khoản </a></li>
                        <li><a href="?mod=logout">Đăng xuất</a></li>
                    <?php } else { ?>
                        <li><a href="?mod=login">Đăng nhập / Đăng ký</a></li>
                    <?php } ?>
                </ul>
            </div>
        </div>
    ...
    <header>
        <div class="sticky">
            <div class="container-full">
                ...
                <!-- <div class="logo"> <a href="?mod=index"><img  class="img-responsive" style="height: 50px;" src="https://cdn.chanhtuoi.com/uploads/2020/06/logo-lazada.png.webp" alt=""></a> </div> -->
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="nav">
                            <li <?php if(isset($_GET['mod']) && $_GET['mod']== "index"){echo "class=\"dropdown active\"";}elseif(!isset($_GET['mod'])){echo "class=\"dropdown active\"";} ?>>
                                <a href="?mod=index">Trang chủ</a></li>
                            <li <?php if(isset($_GET['mod']) && ($_GET['mod']== "shop" || $_GET['mod']=="product")){echo "class=\"dropdown active\"";} ?>> <a href="?mod=shop">Cửa hàng</a> </li>
                            <li <?php if(isset($_GET['mod']) && ($_GET['mod']== "search")){echo "class=\"dropdown active\"";} ?>> <a href="?mod=search">Tìm kiếm</a> </li>
                            <li <?php if(isset($_GET['mod']) && $_GET['mod']== "about"){echo "class=\"dropdown active\"";} ?>> <a href="?mod=about">Về chúng tôi</a> </li>
                            <li <?php if(isset($_GET['mod']) && $_GET['mod']== "contact"){echo "class=\"dropdown active\"";} ?>> <a href="?mod=contact">Liên hệ</a> </li>
                        </ul>
                    </div>
                </nav>
            </div>
