...
<!--                                    penatcing e scelerisque miscing elit. </p>-->
                                <p class="font-weight-bold">Đăng ký lúc: <?= date("H:i:s - d/m/Y", strtotime($dataViews['profile']['uRegisteredAt']))?></p>
                                <p class="font-weight-bold">Cập nhật gần nhất: <?=date("H:i:s - d/m/Y",strtotime($dataViews['profile']['uUpdateAt']))?> </p>
                                <p class="font-weight-bold">Đăng nhập gần nhất: <?=date("H:i:s - d/m/Y",strtotime($dataViews['profile']['uLastLogin']))?> </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-8">
                        <nav>
                            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                <a class="nav-item nav-link active" id="nav-home-tab" data-toggle="tab" href="#nav-home" role="tab" aria-controls="nav-home" aria-selected="true">Thông tin người dùng</a>
                                <a class="nav-item nav-link" id="nav-profile-tab" data-toggle="tab" href="#nav-profile" role="tab" aria-controls="nav-profile" aria-selected="false">Lịch sử đặt hàng</a>
                                    ...
                                    <form class="update-info" id="update-info" method="post" onSubmit="return false">
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" class="form-control" id="first_name" placeholder="Tên" name="uFirstName" value="<?=$dataViews['profile']['uFirstName']?>">
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label for="last_name">Họ <span class="text-danger">*</span></label>
                                                <input type="text" class="form-control" id="last_name" placeholder="Họ" name="uLastName" value="<?=$dataViews['profile']['uLastName']?>">
                                            </div>
                                        </div>
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-4">
                                                <label for="wards">Xã/phường <span class="text-danger">*</span></label>
                                                <div class="form-group">
                                        ...
                                        <button type="submit" class="btn btn-primary" onclick="updateInfo();">Lưu</button>
                                    </form>
                                </div>
                            </div>
                                ...
                                <div class="p-4">
                                    <form id="change-password" method="post" onSubmit="return false" >
                                        ...
                                        <?php
                                            ...
                                            <?php } ?>
                                        <button type="submit" id="btn-change-password" class="btn btn-primary" onclick="changePassword();">Đổi mật khẩu</button>
                                    </form>
                                </div>
                            </div>
                        </div>
