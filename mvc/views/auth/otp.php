                            ...
                            <div class="tab-content" id="myTabContent">
                                ...
                                <div class="tab-pane fade show active" id="log" role="tabpanel" aria-labelledby="login-tab">
                                    <div class="row">
                                        <!-- Name -->
                                        <li class="col-md-12">
                                            <label> Nhập mã OTP bên dưới
                                                <input type="text" id="otp" name="otp" value="" placeholder="Nhập mã xác minh của bạn" class="form-control" required>
                                            </label>
                                        </li>
                                        ...
                                        <li class="col-md-12" style="text-align: center;">
                                            <button type="submit" id="btnReSend" class="btnReSend">Gửi lại OTP</button>
                                        </li>
                                    </ul>
                                </div>
                            </div>
